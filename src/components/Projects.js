        ...
        <Row>
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                <h2>Projects</h2>
                <p>Here are a few highlights of my technical journey showcasing software development, embedded systems, and data analytics.</p>
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  <Nav variant="pills" className="nav-pills mb-5 justify-content-center align-items-center" id="pills-tab">
                    <Nav.Item>
                  ...
                  <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                    ...
                    <Tab.Pane eventKey="second">
                      <p>More of my technical work and experiments can be found on my GitHub profile.</p>
                    </Tab.Pane>
                    <Tab.Pane eventKey="third">
                      <p>Collaborative team challenges and exploratory problem-solving are some things I enjoy the most.</p>
                    </Tab.Pane>
                  </Tab.Content>
                </Tab.Container>
              </div>}
